...
def table1_scenarios():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'table1_scenarios.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.05)
    plt.close()
...
def table2a_infrastructure():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'table2a_infrastructure.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.02)
    plt.close()
...
def table2b_taches():
    ...
    t = ax.table(cellText=data, colLabels=cols, loc='center', cellLoc='center')
    style_table(ax, t, 1.3)
    plt.savefig(os.path.join(OUTPUT_DIR, 'table2b_taches.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.02)
    plt.close()
...
def table2c_capacites():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'table2c_capacites.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.02)
    plt.close()
...
def table2d_bandes():
    ...
    t = ax.table(cellText=data, colLabels=cols, loc='center', cellLoc='center')
    style_table(ax, t, 1.3)
    plt.savefig(os.path.join(OUTPUT_DIR, 'table2d_bandes.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.02)
    plt.close()
...
def table3_scenarios_detail():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'table3_scenarios_detail.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.05)
    plt.close()
...
def table4_metriques():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'table4_metriques.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.05)
    plt.close()
...
def table5_resultats():
    ...
    data = [
        ...
        ['Active Fog Nodes', '0', '5 (12%)', '18 (51%)'],
        ['Adjusted lights (SCOOT)', '0', '18', '360'],
        ['Rerouted vehicles', '0', '445', '2,077'],
        ['Max congestion', '77%', '77%', '63%'],
        ['', '', '', ''],
        ['Edge latency', '3 ms', '3 ms', '3 ms'],
        ['Fog latency', '--', '18 ms', '7 ms'],
        ['Cloud latency', '250 ms', '250 ms', '250 ms'],
        ['', '', '', ''],
        ['Average latency', '~90 ms', '~35 ms', '~18 ms'],
    ]
    table = ax.table(cellText=data, colLabels=cols, loc='center', cellLoc='center')
    style_table(ax, table, 1.3)
    table[(0,1)].set_facecolor(RED)
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'table5_resultats.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.05)
    plt.close()
...
def table6_evolution():
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'table6_evolution.png'), bbox_inches='tight', dpi=200, facecolor='white', pad_inches=0.05)
    plt.close()
...
if __name__ == '__main__':
    ...
    table5_resultats()
    table6_evolution()
    print(f"\n==> 9 table images generated successfully!")
